...
// ==========================================
const ACHIEVEMENTS = [
  // 日記の記録実績 (過去すべての累計件数を基準とする)
  { id: 'diary_1', name: '最初の日記', desc: '累計1件', icon: 'assets/ui/badge_diary_1.svg', condition: (count, total, level, streak) => total >= 1 },
  { id: 'diary_10', name: '日記10件達成', desc: '累計10件', icon: 'assets/ui/badge_diary_10.svg', condition: (count, total, level, streak) => total >= 10 },
  { id: 'diary_30', name: '日記30件達成', desc: '累計30件', icon: 'assets/ui/badge_diary_30.svg', condition: (count, total, level, streak) => total >= 30 },
  { id: 'diary_50', name: '日記50件達成', desc: '累計50件', icon: 'assets/ui/badge_diary_50.svg', condition: (count, total, level, streak) => total >= 50 },
  { id: 'diary_100', name: '日記100件達成', desc: '累計100件', icon: 'assets/ui/badge_diary_100.svg', condition: (count, total, level, streak) => total >= 100 },
  { id: 'diary_150', name: '日記150件達成', desc: '累計150件', icon: 'assets/ui/badge_diary_150.svg', condition: (count, total, level, streak) => total >= 150 },
  { id: 'diary_200', name: '日記200件達成', desc: '累計200件', icon: 'assets/ui/badge_diary_200.svg', condition: (count, total, level, streak) => total >= 200 },
  { id: 'diary_250', name: '日記250件達成', desc: '累計250件', icon: 'assets/ui/badge_diary_250.svg', condition: (count, total, level, streak) => total >= 250 },
  { id: 'diary_300', name: '日記300件達成', desc: '累計300件', icon: 'assets/ui/badge_diary_300.svg', condition: (count, total, level, streak) => total >= 300 },
  { id: 'diary_350', name: '日記350件達成', desc: '累計350件', icon: 'assets/ui/badge_diary_350.svg', condition: (count, total, level, streak) => total >= 350 },
  { id: 'diary_365', name: '365日の記録', desc: '累計365件', icon: 'assets/ui/badge_diary_365.svg', condition: (count, total, level, streak) => total >= 365 },
  { id: 'diary_400', name: '日記400件達成', desc: '累計400件', icon: 'assets/ui/badge_diary_400.svg', condition: (count, total, level, streak) => total >= 400 },
  { id: 'diary_450', name: '日記450件達成', desc: '累計450件', icon: 'assets/ui/badge_diary_450.svg', condition: (count, total, level, streak) => total >= 450 },
  { id: 'diary_500', name: '日記500件達成', desc: '累計500件', icon: 'assets/ui/badge_diary_500.svg', condition: (count, total, level, streak) => total >= 500 },
  { id: 'diary_550', name: '日記550件達成', desc: '累計550件', icon: 'assets/ui/badge_diary_550.svg', condition: (count, total, level, streak) => total >= 550 },
  { id: 'diary_600', name: '日記600件達成', desc: '累計600件', icon: 'assets/ui/badge_diary_600.svg', condition: (count, total, level, streak) => total >= 600 },
  { id: 'diary_650', name: '日記650件達成', desc: '累計650件', icon: 'assets/ui/badge_diary_650.svg', condition: (count, total, level, streak) => total >= 650 },
  { id: 'diary_700', name: '日記700件達成', desc: '累計700件', icon: 'assets/ui/badge_diary_700.svg', condition: (count, total, level, streak) => total >= 700 },
  { id: 'diary_750', name: '日記750件達成', desc: '累計750件', icon: 'assets/ui/badge_diary_750.svg', condition: (count, total, level, streak) => total >= 750 },
  { id: 'diary_800', name: '日記800件達成', desc: '累計800件', icon: 'assets/ui/badge_diary_800.svg', condition: (count, total, level, streak) => total >= 800 },
  { id: 'diary_850', name: '日記850件達成', desc: '累計850件', icon: 'assets/ui/badge_diary_850.svg', condition: (count, total, level, streak) => total >= 850 },
  { id: 'diary_900', name: '日記900件達成', desc: '累計900件', icon: 'assets/ui/badge_diary_900.svg', condition: (count, total, level, streak) => total >= 900 },
  { id: 'diary_950', name: '日記950件達成', desc: '累計950件', icon: 'assets/ui/badge_diary_950.svg', condition: (count, total, level, streak) => total >= 950 },
  { id: 'diary_1000', name: '1000件の金字塔', desc: '累計1000件', icon: 'assets/ui/badge_diary_1000.svg', condition: (count, total, level, streak) => total >= 1000 },
