...
const PLAYER_TITLES = [
  ...
  { minLevel: 10,  title: '駆け出しの書記' },
  { minLevel: 20,  title: '竜卵の守り人' },
  { minLevel: 30,  title: '蒼穹の龍使い' },
  { minLevel: 40,  title: '魔導の書記官' },
  { minLevel: 50,  title: '銀翼の年代記作家' },
  { minLevel: 60,  title: '黄昏の竜騎士' },
  { minLevel: 70,  title: '深淵の賢者' },
  { minLevel: 80,  title: '星読みの大魔導士' },
  { minLevel: 90,  title: '神話の語り部' },
  { minLevel: 100, title: '伝説の竜王' }
];
...
function spawnEvolutionParticles() {
  ...
  for (let i = 0; i < 80; i++) {
    ...
    const delay = Math.random() * 0.5; // 一気に放出
